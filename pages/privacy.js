...
export class Privacy extends Component {
  render() {
    return (
      <Layout>
        <Head
          title={"Wickedity | Privacy"}
          metaTitle={"Wickedity | Privacy"}
          metaKeywords={"wickedity,Privacy Policy"}
          url={typeof window !== "undefined" ? window.location.href : ""}
          metaDescription={"Privacy policy for Wickedity.com"}
          orgTitle={"Wickedity | Privacy"}
          orgDescription={"Privacy policy for Wickedity.com"}
        />
        <Grid className={"gridpushup"}>
          <Grid.Row>
            ...
            >
              ...
              <p>
                Wickedity ("us", "we", or "our") operates the www.wickedity.com
                website (the "Service").
              </p>
              ...
              <p>
                Wickedity will take all steps reasonably necessary to ensure
              ...
              <p>
                Wickedity may disclose your Personal Data in the good faith
                belief that such action is necessary to:
              </p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>
                  To protect and defend the rights or property of Wickedity
                </li>
                <li>
