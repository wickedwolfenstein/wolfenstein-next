...
export class Terms extends Component {
  render() {
    return (
      <Layout>
        <Head
          title={"Wickedity | Terms and Conditions"}
          metaTitle={"Wickedity | Terms and Conditions"}
          metaKeywords={"wickedity, Terms and Conditions"}
          url={typeof window !== "undefined" ? window.location.href : ""}
          metaDescription={"Terms and Conditions for Wickedity.com"}
          orgTitle={"Wickedity | Terms and Conditions"}
          orgDescription={"Terms and Conditions for Wickedity.com"}
        />
        <Grid className={"gridpushup"}>
          <Grid.Row>
            ...
            >
              ...
              <h2>Welcome to Wickedity</h2>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of Wickedity's Website.
              </p>{" "}
              <br />
              <p>
                By accessing this website we assume you accept these terms and
                conditions in full. Do not continue to use Wickedity's website
              ...
              <h2>Cookies</h2>
              <p>
                We employ the use of cookies. By using Wickedity's website you
                consent to the use of cookies in accordance with Wickedity’s
                privacy policy.
              </p>
              <p>
              ...
              <h2>License</h2>
              <p>
                Unless otherwise stated, Wickedity and/or it’s licensors own the
                intellectual property rights for all material on Wickedity. All
                intellectual property rights are reserved. You may view and/or
                print pages from https://www.wickedity.com for your own personal
                use subject to restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ol>
                <li>Republish material from https://www.wickedity.com</li>
                <li>
                  Sell, rent or sub-license material from
                  https://www.wickedity.com
                </li>
                <li>
              ...
              <p>
                Redistribute content from Wickedity (unless content is
              ...
              <ol>
                ...
                <li>
                  Wickedityreserves the right to monitor all Comments and to
                ...
                <li>
                  You hereby grant to <strong>Wickedity</strong> a non-exclusive
              ...
              <p>
                ...
                of Wickedity and (d) where the link is in the context of general
              ...
              <p>
                ...
                <a
                  href="mailto:wickedwolfenstein@gmail.com"
                  title="send an email to wickedwolfenstein@gmail.com"
                >
                  wickedwolfenstein@gmail.com
                </a>
              ...
              <p>
                No use of Wickedity’s logo or other artwork will be allowed for
